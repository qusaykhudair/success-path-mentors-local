...
import {
  EnglishStrandIcon,
} from '@/components/subjects/english/english-strand-icon';
import {
  routePath,
} from '@/config/routes';
import type {
...
interface EnglishStrandPageContentProps {
  locale: SiteLocale;
  strand: EnglishStrandPageData;
  breadcrumbs:
    BreadcrumbItem[];
  bookingHref: string;
}
...
export function EnglishStrandPageContent({
  locale,
  strand,
  breadcrumbs,
  bookingHref,
