...
const PAGE_KEY = 'grade-12-calculus-vectors-mcv4u';
...
export default async function CalculusVectorsPage({
  params,
}: MathCoursePageProps) {
  const { locale } = await params;
  ...
  const breadcrumbs = [
    ...
    { label: 'MCV4U Calculus and Vectors' },
  ];
  ...
  const schemas = [
    ...
    },
    {
      ...
      serviceType: 'MCV4U Calculus Tutoring',
      areaServed: {
        '@type': 'Country',
        name: 'Canada',
      },
