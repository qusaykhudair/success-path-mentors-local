...
export function BackToTopButton({ locale }: BackToTopButtonProps) {
  ...
  return (
    <button
      ...
      title={labels[locale]}
      className={`fixed bottom-[calc(env(safe-area-inset-bottom,0px)+5.75rem)] right-4 z-[44] inline-flex h-12 w-12 items-center justify-center rounded-full border border-slate-200/90 bg-white/95 text-primary-900 shadow-[0_10px_28px_rgba(7,20,38,0.14)] backdrop-blur-md transition-[opacity,transform,box-shadow] duration-200 hover:-translate-y-0.5 hover:shadow-[0_14px_34px_rgba(7,20,38,0.2)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500 focus-visible:ring-offset-2 sm:right-6 sm:h-14 sm:w-14 lg:bottom-[7.25rem] lg:right-8 ${
        visible
